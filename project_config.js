...
LibModules = ["system", "bios", "vdp", "print", "input", "memory", "math", "string", "psg", "game_menu", "sprite_fx", "draw", "debug", "compress/pletter"];
LibModules = ["arkos/akg_player", "arkos/akm_player", "arkos/aky_player", ...LibModules];

//-- Additional sources to be compiled and linked with the project (array)
// AddSources = [];
//AddSources = ["teste_playerconfig.asm", "teste.asm"];
