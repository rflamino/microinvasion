...
#define POWERUP_WALLWALK_TIME   300   // Frames the wall–walk powerup lasts
...
#define GRAVITY_POWERUP_TIME 300   // Duration (in frames) for which gravity mode is active
